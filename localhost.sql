...
--
-- Host: localhost
-- Tempo de geração: 20/09/2020 às 18:25
...
('WESLEY', 'w@W', '1990-11-02', 1),
(' JOSE ALMEIDA', 'J@J', '1995-12-07', 2),
('WESLEY LUAN', 'w2@3W', '1996-10-09', 3);
...
('Analise e Desenvolvimento de Sistema', '3 Anos', 1),
('Segurança da informação', '5 Anos', 2),
('Administração', '2 Anos', 3);
...
ALTER TABLE `cursos`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- Banco de dados: `dogcursos2`
--
CREATE DATABASE IF NOT EXISTS `dogcursos2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dogcursos2`;
--
...
('root', '[{\"db\":\"wesleyluan\",\"table\":\"usuarios\"},{\"db\":\"wesleyluan\",\"table\":\"cursos\"},{\"db\":\"wesleyluan\",\"table\":\"alunos_cursos\"},{\"db\":\"wesleyluan\",\"table\":\"alunos\"},{\"db\":\"aula_php\",\"table\":\"alunos\"},{\"db\":\"aula_php\",\"table\":\"aluno_curso\"},{\"db\":\"aula_php\",\"table\":\"cursos\"},{\"db\":\"aula_php\",\"table\":\"ALUNOS\"}]');
...
('root', '2020-09-20 16:09:13', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\",\"NavigationWidth\":241}');
...
--
CREATE DATABASE IF NOT EXISTS `wesleyluan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `wesleyluan`;
